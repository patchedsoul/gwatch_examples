...
_dev_path = _get_dbus_path(mngd_objs, _adt_path, DEVICE_INTERFACE, 'Address', device)
_srv_path = _get_dbus_path(mngd_objs, _dev_path, GATT_SERVICE_IFACE, 'UUID', _valid_uuid(service))
_chr_path = _get_dbus_path(mngd_objs, _srv_path, GATT_CHRC_IFACE, 'UUID', _valid_uuid(characteristic))
_dsr_path = _get_dbus_path(mngd_objs, _chr_path, GATT_DESC_IFACE, 'UUID', _valid_uuid(descriptor))
